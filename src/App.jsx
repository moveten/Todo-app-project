...
const styles = {
  ...
  card: { display: "flex", alignItems: "flex-start", background: "#FFFFFF", borderRadius: 14, padding: "12px 14px", boxShadow: "0 1px 3px rgba(15,23,42,0.06)", gap: 10 },
  swipeWrap: { position: "relative", overflow: "hidden", borderRadius: 14, marginBottom: 6 },
